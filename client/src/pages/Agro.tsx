...
const PILARES = [
  {
    ...
    texto:
      "Titulação, usucapião rural e regularização junto a INCRA, ITERACRE e SPU.",
  ...
  },
  {
    ...
    texto:
      "CAR, Reserva Legal, APP e defesa em autos de infração e embargos do IBAMA/IMAC.",
    href: "/ambiental-rural",
  },
  {
    icon: Tractor,
    titulo: "Aposentadoria Rural",
    texto:
      "Benefício do trabalhador rural e do segurado especial, com prova material organizada.",
...
const AGRO_TEMAS = [
  {
    ...
    titulo: "Regularização Fundiária",
    texto:
      "Titulação, usucapião rural e regularização junto a INCRA, ITERACRE e SPU para garantir a propriedade da terra.",
    href: "/regularizacao-fundiaria",
  },
  {
    icon: FileCheck,
    ...
    texto:
      "Inscrição, retificação e validação do CAR, pré-requisito para acesso a crédito e regularização ambiental.",
    href: "/ambiental-rural",
  },
  {
    icon: TreePine,
    titulo: "Reserva Legal e APP",
    texto:
      "Adequação ao Código Florestal: recomposição, regeneração natural ou compensação de Reserva Legal e APP.",
    href: "/ambiental-rural",
  },
  {
    icon: Sprout,
    titulo: "PRA — Programa de Regularização Ambiental",
    texto:
      "Análise de cabimento e adesão ao PRA para regularização de passivos, conforme os requisitos legais.",
    href: "/ambiental-rural",
  },
  {
    icon: MapPinned,
    ...
    texto:
      "Certificação INCRA dos limites do imóvel, requisito para atos registrais e segurança jurídica da propriedade.",
    href: "/regularizacao-fundiaria",
  },
  {
    icon: Building2,
    titulo: "IMAC — Defesa Administrativa",
    texto:
      "Defesa em autos de infração e embargos do órgão ambiental estadual.",
    href: "/blog/embargo-ambiental-acre",
  },
  {
    icon: Shield,
    titulo: "IBAMA — Defesa em Embargos",
    texto:
      "Defesa técnica contra autos de infração, multas e embargos federais, com análise de vícios e proporcionalidade.",
    href: "/blog/embargo-ambiental-acre",
  },
  {
    icon: Gavel,
    ...
    texto:
      "Assessoria em processos de licenciamento para atividades rurais, incluindo LP, LI e LO.",
    href: "/ambiental-rural",
  },
  {
    icon: Tractor,
    titulo: "Produtor Rural — Direitos e Obrigações",
    texto:
      "Orientação jurídica completa para o produtor: contratos agrários, crédito rural, PRONAF e seguro agrícola.",
  },
];
...
const AGRO_CONTEUDOS = [
  {
    ...
    titulo: "Multa do IBAMA no Acre: como funciona a defesa",
    categoria: "Defesa IBAMA",
  },
  {
    slug: "embargo-ambiental-acre",
    titulo: "Embargo ambiental: como desembargar a propriedade",
    categoria: "Embargos",
  },
  {
    slug: "regularizar-propriedade-rural-acre",
    titulo: "Como regularizar propriedade rural no Acre",
    categoria: "Fundiário",
  },
  {
    slug: "agro-regularizacao-ambiental",
    titulo: "CAR e PRA no Acre: regularização ambiental",
    categoria: "CAR/PRA",
  },
];
...
export default function Agro() {
  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden pt-28 pb-20 text-white lg:pt-40 lg:pb-28">
        ...
        <div className="container relative max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-white/80 text-pretty">
            Regularização fundiária, conformidade ambiental e direito
            previdenciário rural reunidos em um único hub. Segurança jurídica
            para a sua terra, o seu negócio e a sua família.
          </p>
        ...
        <div className="container">
          <div className="reveal max-w-2xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              As demandas do campo se conectam. Atuamos de forma integrada para
              resolver a raiz do problema, não apenas o sintoma.
            </p>
          </div>
        ...
        <div className="container relative grid gap-12 lg:grid-cols-2">
          <div className="reveal">
            <Eyebrow className="text-white/70">
              Por que o produtor confia
            </Eyebrow>
            <h2 className="mt-4 font-serif text-3xl font-semibold text-balance">
              Visão jurídica e negocial do agronegócio
            </h2>
            <p className="mt-4 text-base leading-relaxed text-white/75">
              Combinamos técnica jurídica com entendimento da realidade do campo
              acreano. O objetivo é dar previsibilidade e proteger o patrimônio
              rural.
            </p>
          </div>
          <ul className="reveal space-y-4">
            {[
              ...
              "Defesa técnica em autos de infração e embargos (IBAMA/IMAC)",
      ...
      <section className="bg-background py-20">
        <div className="container">
          <div className="reveal max-w-2xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              Cada tema do agronegócio exige conhecimento específico. Confira as
              áreas que dominamos para proteger seu patrimônio rural no Acre.
            </p>
          </div>
            ...
            {AGRO_TEMAS.map((tema, i) => {
              ...
              return "href" in tema && tema.href ? (
                <Link
                  key={tema.titulo}
                  href={tema.href}
                  className={`${cls} lift hover:border-agro/40`}
      ...
      <section className="bg-secondary/30 py-20">
        <div className="container">
          <div className="reveal max-w-2xl">
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              Artigos técnicos sobre as situações mais comuns enfrentadas pelo
              produtor no Acre.
            </p>
          </div>
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            {AGRO_CONTEUDOS.map(c => (
              ...
              >
                <span className="text-xs font-semibold uppercase tracking-wider text-agro">
                  {c.categoria}
                </span>
      ...
      <CtaBand
        titulo="Sua propriedade precisa de segurança jurídica?"
        texto="Solicite uma avaliação individual da situação documental, fundiária ou ambiental."
      />
    </Layout>
  );
}
